...
define( 'DB_NAME', 'wordpress-elements-woocommerce' );
define( 'DB_USER', 'root' );
...
define( 'SITE_PATH', 'wordpress-elements-woocommerce'); // the path to the root of your project, relative to the hostname aka the part of the url that comes after the hostname. Don't use a leading /.
